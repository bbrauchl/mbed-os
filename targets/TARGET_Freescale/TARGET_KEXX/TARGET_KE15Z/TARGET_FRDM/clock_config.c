 ...
 * Definitions
 ******************************************************************************/
#define SIM_CHIPCTL_RTC32KCLKSEL_OSC32                    0U  /*!< RTC 32KHz clock input select: OSC32 clock */
...
/*FUNCTION**********************************************************************
 *
 * Function Name : CLOCK_CONFIG_SetRtc32KClkSrc
 * Description   : Set the 32 KHz clock source for RTC.
 * Param src     : The clock to be used as RTC 32 KHz clock.
 *
 *END**************************************************************************/
static void CLOCK_CONFIG_SetRtc32KClkSrc(uint8_t src)
{
     SIM->CHIPCTL = ((SIM->CHIPCTL & ~SIM_CHIPCTL_RTC32KCLKSEL_MASK) | SIM_CHIPCTL_RTC32KCLKSEL(src));
}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* OSC32 work mode configuration. */
    OSC32_Init(OSC32, kOSC32_Bypass);
    /* Init LPFLL. */
